...
//   -
//   - Amply Extension is a software: you can redistribute it, but you are not allowed to modify it under the terms of the Creative Commons Attribution-NonCommercial-NoDerivatives 4.0 International (CC BY-NC-ND 4.0) License.
//   -
...
(() => {
  ...
  (() => {
    ...
    const fonts = ["lucide","roboto", "poppins", "caprasimo", "playfair", "merriweather", "noto_sans", "nunito", "montserrat", "pixelify", "gabarito", "roboto_condensed", "inter"];
...
(() => {
  "use strict";
  (() => {
    const APPEAR_TIMEOUT = 4 * 1000 * 60;
    // const APPEAR_TIMEOUT = 2000;
    const MAX_CLOSE_COUNT = 4;
    const browser_cr = chrome ? chrome : browser;
    const STORE_LINKS = {
      "chrome": "https://chromewebstore.google.com/detail/afcocefjhnalmnihbmepaefkginkmkdb/reviews",
      "firefox": "https://addons.mozilla.org/en-US/firefox/addon/amply-extension/reviews",
      "edge": "https://chromewebstore.google.com/detail/afcocefjhnalmnihbmepaefkginkmkdb/reviews",
      "opera": "https://chromewebstore.google.com/detail/afcocefjhnalmnihbmepaefkginkmkdb/reviews"
    }
...
(() => {
  ...
  waitForElement(".VUXMMFKWudUWE1kIXZoS.rwdnt1SmeRC_lhLVfIzg", (parent) => {
...
//         "subtitle_1": "Vielen Dank, dass Sie Amply verwenden! Wir (mein enger Freund und ich) haben unzählige Stunden darauf verwendet, ein gesünderes, ablenkungsfreies und vollständig anpassbares SoundCloud-Erlebnis zu schaffen. Wenn Sie Amply schätzen und wertvoll finden, ziehen Sie bitte in Betracht, das Projekt mit einer kleinen Spende zu unterstützen. Ihr Beitrag hilft uns, neue Funktionen hinzuzufügen und sicherzustellen, dass die Erweiterung für alle kostenlos bleibt.",
//         "title_2": "Warum ist das wichtig?",
//         "subtitle_2": "Ihre Spende ermöglicht es uns, mehr Anpassungsoptionen und ablenkungsfreie Modi einzuführen und Amply auf jedem Gerät reibungslos laufen zu lassen.",
...
//         "sup": "Jeder Schritt, den wir unternehmen, um SoundCloud zu verbessern, wird von großartigen Nutzern wie Ihnen ermöglicht!",
//         "rem_btn": "Erinnere mich später",
//         "more_btn": "Mehr über das Projekt"
//       },
//       es: {
//         "title": "Tu apoyo nos inspira a mejorar.",
//         "subtitle_1": "Gracias por usar Amply. Nosotros (mi amigo cercano y yo) hemos dedicado innumerables horas a crear una experiencia de SoundCloud más saludable, sin distracciones y completamente personalizable. Si valoras Amply y lo encuentras útil, considera apoyar el proyecto con una pequeña donación. Tu contribución nos ayuda a agregar nuevas funciones y a mantener la extensión gratuita para todos.",
//         "title_2": "¿Por qué es importante?",
//         "subtitle_2": "Tu donación nos permite introducir más opciones de personalización y modos libres de distracciones, además de mantener Amply funcionando sin problemas en cada dispositivo.",
...
//         "sup": "¡Cada paso que damos para mejorar SoundCloud es gracias a usuarios increíbles como tú!",
//         "rem_btn": "Recuérdame más tarde",
//         "more_btn": "Más sobre el proyecto"
//       },
//       pl: {
//         "title": "Twoje wsparcie inspiruje nas do doskonalenia.",
//         "subtitle_1": "Dziękujemy za korzystanie z Amply! My (ja i mój bliski przyjaciel) poświęciliśmy niezliczone godziny na stworzenie zdrowszego, pozbawionego rozpraszaczy i w pełni dostosowanego doświadczenia SoundClouda. Jeśli cenisz Amply i uważasz, że jest wartościowym, rozważ wsparcie projektu drobną darowizną. Twój wkład pomaga nam dodawać nowe funkcje i zapewnia, że rozszerzenie pozostaje darmowe dla wszystkich.",
//         "title_2": "Dlaczego to ważne?",
//         "subtitle_2": "Twoje wsparcie pozwala nam wprowadzać więcej opcji personalizacji i trybów bez rozpraszania oraz utrzymywać Amply w płynnej pracy na każdym urządzeniu.",
...
//         "sup": "Każdy krok, który podejmujemy, aby ulepszyć SoundCloud, jest możliwy dzięki osobom takim jak Ty!",
//         "rem_btn": "Przypomnij mi później",
//         "more_btn": "Więcej o projekcie"
//       },
//       uk: {
//         "title": "Ваша підтримка надихає нас на вдосконалення.",
//         "subtitle_1": "Дякуємо, що користуєтесь Amply! Ми (я та мій близький друг) присвятили безліч годин створенню здоровішого, без відволікань і повністю персоналізованого досвіду SoundCloud. Якщо вам подобається Amply і ви вважаєте його корисним, розгляньте можливість підтримати проєкт невеликою пожертвою. Ваш внесок допомагає нам додавати нові функції та забезпечувати безкоштовність додатку для всіх.",
//         "title_2": "Чому це важливо?",
//         "subtitle_2": "Ваш внесок дозволяє нам додавати більше налаштувань і режимів без відволікань, а також забезпечувати стабільну роботу Amply на кожному пристрої.",
...
//         "sup": "Кожен крок до покращення SoundCloud здійснюється завдяки таким чудовим користувачам, як ви!",
//         "rem_btn": "Нагадати пізніше",
//         "more_btn": "Дізнатися більше про проєкт"
//       },
//       sv: {
//         "title": "Ditt stöd inspirerar oss att förbättra.",
//         "subtitle_1": "Tack för att du använder Amply! Vi (jag och min nära vän) har ägnat otaliga timmar åt att skapa en SoundCloud-upplevelse som är hälsosammare, fri från distraktioner och helt anpassningsbar. Om du uppskattar Amply och tycker det är värdefullt, överväg att stödja projektet med en liten donation. Ditt bidrag hjälper oss att lägga till nya funktioner och hålla tillägget gratis för alla.",
//         "title_2": "Varför är det viktigt?",
//         "subtitle_2": "Din donation gör det möjligt för oss att introducera fler anpassningsalternativ och distraktionsfria lägen och att hålla Amply igång smidigt på varje enhet.",
...
//         "sup": "Varje steg vi tar för att förbättra SoundCloud är tack vare fantastiska användare som du!",
//         "rem_btn": "Påminn mig senare",
//         "more_btn": "Mer om projektet"
//       },
//       ar: {
//         "title": "دعمك يلهمنا للتحسين.",
//         "subtitle_1": "شكرًا لاستخدامك Amply! نحن (أنا وصديقي المقرب) قضينا ساعات لا تحصى في إنشاء تجربة إنستغرام أكثر صحة وخالية من التشتت وقابلة للتخصيص بالكامل. إذا كنت تستمتع بـ Amply وتجدها ذات قيمة، فكر في دعم المشروع بتبرع صغير. يساعدنا تبرعك في إضافة ميزات جديدة والحفاظ على الإضافة مجانية للجميع.",
//         "title_2": "لماذا هذا مهم؟",
//         "subtitle_2": "يسمح لنا تبرعك بإضافة المزيد من خيارات التخصيص وأنماط خالية من التشتت، والحفاظ على تشغيل Amply بسلاسة على كل جهاز.",
//         "title_3": "مكافآت لك:",
...
//         "subtitle_1": "Дзякуй, што выкарыстоўваеце Amply! Мы (я і мой блізкі сябар) прысвяцілі незлічоныя гадзіны стварэнню здаровага, безадцягальнага і цалкам наладжвальнага вопыту SoundCloud. Калі вы цэніце Amply і лічыце яго карысным, разгледзьце магчымасць падтрымкі праекта невялікім ахвяраваннем. Ваш унёсак дапамагае нам дадаваць новыя функцыі і забяспечваць бясплатнасць пашырэння для ўсіх.",
//         "title_2": "Чаму гэта важна?",
//         "subtitle_2": "Ваш ахвяраванне дазваляе нам уводзіць больш варыянтаў налад і рэжымаў без адцягненняў, а таксама падтрымліваць стабільную працу Amply на кожнай прыладзе.",
...
//         "sup": "Кожны крок, які мы робім для паляпшэння SoundCloud, магчыма дзякуючы цудоўным карыстальнікам, як вы!",
//         "rem_btn": "Нагадаць пазней",
//         "more_btn": "Больш пра праект"
//       },
//       ru: {
//         "title": "Ваша поддержка вдохновляет нас на улучшения.",
//         "subtitle_1": "Спасибо, что используете Amply! Мы (я и мой близкий друг) посвятили множество часов созданию более здорового, свободного от отвлечений и полностью настраиваемого опыта в SoundCloud. Если вам нравится Amply и вы находите его полезным, рассмотрите возможность поддержать проект небольшой пожертвованием. Ваш вклад помогает нам добавлять новые функции и обеспечивает бесплатность расширения для всех.",
//         "title_2": "Почему это важно?",
//         "subtitle_2": "Ваше пожертвование позволяет нам внедрять больше опций настройки, режимов без отвлечений и поддерживать Amply в стабильной работе на каждом устройстве.",
//         "title_3": "Бонусы для вас:",
...
//         "sup": "Каждый наш шаг к улучшению SoundCloud становится возможным благодаря таким удивительным пользователям, как вы!",
//         "rem_btn": "Напомнить позже",
//         "more_btn": "Подробнее о проекте"
//       },
//       en: {
//         "title": "Your support inspires us to improve.",
//         "subtitle_1": "Thank you for using Amply! We (me and my close friend) have dedicated countless hours to creating an SoundCloud experience that’s healthier, distraction-free, and entirely customizable. If you enjoy Amply and find it valuable, consider supporting the project with a small donation. Your contribution helps us add new features and ensures the extension remains free for everyone.",
//         "title_2": "Why does it matter?",
//         "subtitle_2": "Your donation allows us to introduce more customization options and distraction-free modes and keep Amply running smoothly on each device.",
...
//         "sup": "Every step we take to make SoundCloud better is powered by users like you!",
//         "rem_btn": "Remind me later",
//         "more_btn": "More about the project"
//       },
//       fr: {
//         "title": "Votre soutien nous inspire à nous améliorer.",
//         "subtitle_1": "Merci d'utiliser Amply ! Nous (mon ami proche et moi) avons consacré d'innombrables heures à créer une expérience SoundCloud plus saine, sans distraction et entièrement personnalisable. Si vous appréciez Amply et le trouvez utile, envisagez de soutenir le projet avec un petit don. Votre contribution nous aide à ajouter de nouvelles fonctionnalités et garantit que l'extension reste gratuite pour tous.",
//         "title_2": "Pourquoi est-ce important ?",
//         "subtitle_2": "Votre don nous permet d'introduire davantage d'options de personnalisation et de modes sans distraction, et de maintenir Amply fonctionnel sur chaque appareil.",
...
//         "sup": "Chaque étape que nous franchissons pour améliorer SoundCloud est rendue possible grâce à des utilisateurs incroyables comme vous !",
...
//         "subtitle_1": "Amply का उपयोग करने के लिए धन्यवाद! हमने (मैं और मेरा करीबी दोस्त) इंस्टाग्राम को एक स्वस्थ, ध्यान-मुक्त और पूरी तरह से अनुकूलन योग्य अनुभव बनाने के लिए अनगिनत घंटे समर्पित किए हैं। यदि आपको Amply उपयोगी और मूल्यवान लगता है, तो कृपया परियोजना का समर्थन करने के लिए एक छोटा सा दान करने पर विचार करें। आपका योगदान हमें नई सुविधाएँ जोड़ने में मदद करता है और यह सुनिश्चित करता है कि एक्सटेंशन सभी के लिए निःशुल्क रहे।",
//         "title_2": "यह क्यों महत्वपूर्ण है?",
//         "subtitle_2": "आपका दान हमें अधिक अनुकूलन विकल्प और ध्यान-मुक्त मोड पेश करने और Amply को हर डिवाइस पर सुचारू रूप से चलाने की अनुमति देता है।",
...
//         "subtitle_1": "Amplyをご利用いただきありがとうございます！私たち（私と親友）は、SoundCloudをより健康的で気を散らすことのない、完全にカスタマイズ可能な体験にするために無数の時間を費やしてきました。Amplyを価値あるものだと感じていただけたなら、小額の寄付でプロジェクトを支援することを検討してください。皆さまのご協力は、新機能を追加し、この拡張機能をすべての人に無料で提供し続ける助けとなります。",
//         "title_2": "なぜこれが重要なのですか？",
//         "subtitle_2": "皆さまの寄付により、さらなるカスタマイズオプションや気を散らさないモードを導入し、すべてのデバイスでAmplyがスムーズに動作するよう維持できます。",
//         "title_3": "あなたへの特典：",
...
//         "don_2": "Ko-Fi.comで寄付",
//         "don_3": "暗号通貨で寄付",
//         "sup": "SoundCloudをより良くするための私たちの一歩一歩は、皆さまのような素晴らしいユーザーのおかげです！",
//         "rem_btn": "後で通知",
//         "more_btn": "プロジェクトの詳細"
//       },
//       nl: {
//         "title": "Uw steun inspireert ons om te verbeteren.",
//         "subtitle_1": "Bedankt voor het gebruik van Amply! Wij (mijn goede vriend en ik) hebben talloze uren besteed aan het creëren van een gezondere, afleidingsvrije en volledig aanpasbare SoundCloud-ervaring. Als u Amply waardeert en nuttig vindt, overweeg dan om het project te steunen met een kleine donatie. Uw bijdrage helpt ons nieuwe functies toe te voegen en ervoor te zorgen dat de extensie gratis blijft voor iedereen.",
//         "title_2": "Waarom is dit belangrijk?",
//         "subtitle_2": "Uw donatie stelt ons in staat om meer aanpassingsopties en afleidingsvrije modi te introduceren en Amply soepel te laten werken op elk apparaat.",
...
//         "sup": "Elke stap die we zetten om SoundCloud te verbeteren, is mogelijk dankzij geweldige gebruikers zoals u!",
//         "rem_btn": "Herinner me later",
//         "more_btn": "Meer over het project"
//       },
//       zh: {
//         "title": "您的支持激励我们不断改进。",
//         "subtitle_1": "感谢您使用 Amply！我和我的密友花费了无数时间来打造一个更健康、无干扰且完全可定制的 SoundCloud 使用体验。如果您喜欢 Amply 并觉得它有价值，请考虑通过小额捐赠支持这个项目。您的贡献将帮助我们添加新功能，并确保扩展程序对所有人免费。",
//         "title_2": "为什么重要？",
//         "subtitle_2": "您的捐赠使我们能够引入更多自定义选项和无干扰模式，并确保 Amply 在每台设备上顺畅运行。",
//         "title_3": "为您准备的奖励：",
...
//         "don_2": "通过Ko-Fi.com捐赠",
//         "don_3": "用加密货币捐赠",
//         "sup": "我们每一步提升 SoundCloud 的努力都离不开像您这样了不起的用户！",
//         "rem_btn": "稍后提醒我",
//         "more_btn": "了解更多关于项目的信息"
//       },
//       pt: {
//         "title": "Seu apoio nos inspira a melhorar.",
//         "subtitle_1": "Obrigado por usar o Amply! Eu e meu amigo próximo dedicamos inúmeras horas para criar uma experiência no SoundCloud mais saudável, sem distrações e totalmente personalizável. Se você gosta do Amply e acha valioso, considere apoiar o projeto com uma pequena doação. Sua contribuição nos ajuda a adicionar novos recursos e garante que a extensão permaneça gratuita para todos.",
//         "title_2": "Por que isso é importante?",
//         "subtitle_2": "Sua doação nos permite introduzir mais opções de personalização, modos sem distração e manter o Amply funcionando perfeitamente em cada dispositivo.",
...
//         "sup": "Cada passo que damos para melhorar o SoundCloud é impulsionado por usuários incríveis como você!",
...
//       <a href="https://github.com/gerwld/Amply-extension/blob/main/README.md" target="_blank">${translations[current_lang].more_btn}</a>
//     </div>
//   </div>
